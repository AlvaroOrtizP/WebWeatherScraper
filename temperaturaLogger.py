...
nombre_archivo = "data/Aemet/"f"datos_aemet_{fecha_actual}.json"
...
# Guardar los datos en un archivo JSON
if datos_aemet_por_dia:
    guardar_json(datos_aemet_por_dia, "datos_aemet_por_dia.json")
    print("Datos guardados correctamente en datos_aemet_por_dia.json")
